#!/usr/bin/env bash
# power-limit-5090.sh — RTX 5090 power limit manager
# Requires sudo (nvidia-smi -pl writes to the driver).
#
# Usage:
#   ./power-limit-5090.sh [watts|default|max|min|status]
#
#   ./power-limit-5090.sh status    # show current limits (no sudo needed)
#   ./power-limit-5090.sh default   # 575 W  — stock TDP
#   ./power-limit-5090.sh max       # 600 W  — maximum allowed
#   ./power-limit-5090.sh min       # 400 W  — current board minimum
#   ./power-limit-5090.sh 500       # 500 W  — custom value
#   ./power-limit-5090.sh 575       # same as "default"
#
