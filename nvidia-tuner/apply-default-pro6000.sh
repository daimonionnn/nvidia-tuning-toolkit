...
PROFILE_POWER_LIMIT=600
PROFILE_CORE_OFFSET=0

echo "Applying nvidia-tuner default profile (RTX PRO 6000): core ${PROFILE_CORE_OFFSET}, memory +${PROFILE_MEMORY_OFFSET}, power ${PROFILE_POWER_LIMIT}W"
